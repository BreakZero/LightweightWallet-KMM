...
@class SharedDatabaseDriverFactory, SharedEtherTransactionInfo, SharedEtherScanTxListResponse, SharedCoinConfig, SharedRuntimeQuery<__covariant RowType>, SharedRuntimeTransacterTransaction, SharedKotlinThrowable, SharedKotlinArray<T>, SharedKotlinException, SharedKotlinRuntimeException, SharedKotlinIllegalStateException, SharedKotlinByteArray, SharedKotlinx_serialization_coreSerializersModule, SharedKotlinx_serialization_coreSerialKind, SharedKotlinNothing, SharedKotlinByteIterator;

@protocol SharedCoinConfigQueries, SharedRuntimeTransactionWithoutReturn, SharedRuntimeTransactionWithReturn, SharedRuntimeTransacter, SharedWalletDatabase, SharedRuntimeSqlDriver, SharedRuntimeSqlDriverSchema, SharedKotlinx_serialization_coreKSerializer, SharedBlockChairApi, SharedRuntimeTransactionCallbacks, SharedRuntimeSqlPreparedStatement, SharedRuntimeSqlCursor, SharedRuntimeCloseable, SharedKotlinx_serialization_coreEncoder, SharedKotlinx_serialization_coreSerialDescriptor, SharedKotlinx_serialization_coreSerializationStrategy, SharedKotlinx_serialization_coreDecoder, SharedKotlinx_serialization_coreDeserializationStrategy, SharedRuntimeQueryListener, SharedKotlinx_serialization_coreCompositeEncoder, SharedKotlinAnnotation, SharedKotlinx_serialization_coreCompositeDecoder, SharedKotlinIterator, SharedKotlinx_serialization_coreSerializersModuleCollector, SharedKotlinKClass, SharedKotlinKDeclarationContainer, SharedKotlinKAnnotatedElement, SharedKotlinKClassifier;
...
__attribute__((swift_name("WalletDatabase")))
@protocol SharedWalletDatabase <SharedRuntimeTransacter>
@required
@property (readonly) id<SharedCoinConfigQueries> coinConfigQueries __attribute__((swift_name("coinConfigQueries")));
@end;

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("WalletDatabaseCompanion")))
@interface SharedWalletDatabaseCompanion : SharedBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
- (id<SharedWalletDatabase>)invokeDriver:(id<SharedRuntimeSqlDriver>)driver __attribute__((swift_name("invoke(driver:)")));
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("TestSDK")))
@interface SharedTestSDK : SharedBase
...
- (NSString *)getResult __attribute__((swift_name("getResult()")));
@end;

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("EtherScanTxListResponse")))
@interface SharedEtherScanTxListResponse : SharedBase
- (instancetype)initWithMessage:(NSString *)message result:(NSArray<SharedEtherTransactionInfo *> *)result status:(NSString *)status __attribute__((swift_name("init(message:result:status:)"))) __attribute__((objc_designated_initializer));
- (NSString *)component1 __attribute__((swift_name("component1()")));
- (NSArray<SharedEtherTransactionInfo *> *)component2 __attribute__((swift_name("component2()")));
- (NSString *)component3 __attribute__((swift_name("component3()")));
- (SharedEtherScanTxListResponse *)doCopyMessage:(NSString *)message result:(NSArray<SharedEtherTransactionInfo *> *)result status:(NSString *)status __attribute__((swift_name("doCopy(message:result:status:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) NSString *message __attribute__((swift_name("message")));
@property (readonly) NSArray<SharedEtherTransactionInfo *> *result __attribute__((swift_name("result")));
@property (readonly) NSString *status __attribute__((swift_name("status")));
@end;

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("EtherScanTxListResponse.Companion")))
@interface SharedEtherScanTxListResponseCompanion : SharedBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("EtherTransactionInfo")))
@interface SharedEtherTransactionInfo : SharedBase
- (instancetype)initWithBlockHash:(NSString *)blockHash blockNumber:(NSString *)blockNumber confirmations:(NSString *)confirmations contractAddress:(NSString *)contractAddress cumulativeGasUsed:(NSString *)cumulativeGasUsed from:(NSString *)from gas:(NSString *)gas gasPrice:(NSString *)gasPrice gasUsed:(NSString *)gasUsed hash:(NSString *)hash input:(NSString *)input isError:(NSString *)isError nonce:(NSString *)nonce timeStamp:(NSString *)timeStamp to:(NSString *)to transactionIndex:(NSString *)transactionIndex txreceiptStatus:(NSString *)txreceiptStatus value:(NSString *)value __attribute__((swift_name("init(blockHash:blockNumber:confirmations:contractAddress:cumulativeGasUsed:from:gas:gasPrice:gasUsed:hash:input:isError:nonce:timeStamp:to:transactionIndex:txreceiptStatus:value:)"))) __attribute__((objc_designated_initializer));
- (NSString *)component1 __attribute__((swift_name("component1()")));
...
- (SharedEtherTransactionInfo *)doCopyBlockHash:(NSString *)blockHash blockNumber:(NSString *)blockNumber confirmations:(NSString *)confirmations contractAddress:(NSString *)contractAddress cumulativeGasUsed:(NSString *)cumulativeGasUsed from:(NSString *)from gas:(NSString *)gas gasPrice:(NSString *)gasPrice gasUsed:(NSString *)gasUsed hash:(NSString *)hash input:(NSString *)input isError:(NSString *)isError nonce:(NSString *)nonce timeStamp:(NSString *)timeStamp to:(NSString *)to transactionIndex:(NSString *)transactionIndex txreceiptStatus:(NSString *)txreceiptStatus value:(NSString *)value __attribute__((swift_name("doCopy(blockHash:blockNumber:confirmations:contractAddress:cumulativeGasUsed:from:gas:gasPrice:gasUsed:hash:input:isError:nonce:timeStamp:to:transactionIndex:txreceiptStatus:value:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
...
@property (readonly) NSString *confirmations __attribute__((swift_name("confirmations")));
@property (readonly) NSString *contractAddress __attribute__((swift_name("contractAddress")));
@property (readonly) NSString *cumulativeGasUsed __attribute__((swift_name("cumulativeGasUsed")));
@property (readonly) NSString *from __attribute__((swift_name("from")));
@property (readonly) NSString *gas __attribute__((swift_name("gas")));
@property (readonly) NSString *gasPrice __attribute__((swift_name("gasPrice")));
...
@property (readonly) NSString *isError __attribute__((swift_name("isError")));
...
@property (readonly) NSString *txreceiptStatus __attribute__((swift_name("txreceiptStatus")));
@property (readonly) NSString *value __attribute__((swift_name("value")));
@end;

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("EtherTransactionInfo.Companion")))
@interface SharedEtherTransactionInfoCompanion : SharedBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
- (id<SharedKotlinx_serialization_coreKSerializer>)serializer __attribute__((swift_name("serializer()")));
...
__attribute__((swift_name("BlockChairApi")))
@protocol SharedBlockChairApi
@required
...
*/
- (void)txHistoryFromEtherscanWithCompletionHandler:(void (^)(NSArray<SharedEtherTransactionInfo *> * _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("txHistoryFromEtherscan(completionHandler:)")));
@end;

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("BlockChairApiImpl")))
@interface SharedBlockChairApiImpl : SharedBase <SharedBlockChairApi>
- (instancetype)init __attribute__((swift_name("init()"))) __attribute__((objc_designated_initializer));
+ (instancetype)new __attribute__((availability(swift, unavailable, message="use object initializers instead")));
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("CoinConfig")))
@interface SharedCoinConfig : SharedBase
- (instancetype)initWithCoin_symbol:(NSString *)coin_symbol coin_name:(NSString *)coin_name coin_decimal:(int32_t)coin_decimal display_decimal:(int32_t)display_decimal accent_color:(NSString *)accent_color is_active:(BOOL)is_active __attribute__((swift_name("init(coin_symbol:coin_name:coin_decimal:display_decimal:accent_color:is_active:)"))) __attribute__((objc_designated_initializer));
- (NSString *)component1 __attribute__((swift_name("component1()")));
- (NSString *)component2 __attribute__((swift_name("component2()")));
...
- (SharedCoinConfig *)doCopyCoin_symbol:(NSString *)coin_symbol coin_name:(NSString *)coin_name coin_decimal:(int32_t)coin_decimal display_decimal:(int32_t)display_decimal accent_color:(NSString *)accent_color is_active:(BOOL)is_active __attribute__((swift_name("doCopy(coin_symbol:coin_name:coin_decimal:display_decimal:accent_color:is_active:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) NSString *accent_color __attribute__((swift_name("accent_color")));
@property (readonly) int32_t coin_decimal __attribute__((swift_name("coin_decimal")));
@property (readonly) NSString *coin_name __attribute__((swift_name("coin_name")));
@property (readonly) NSString *coin_symbol __attribute__((swift_name("coin_symbol")));
@property (readonly) int32_t display_decimal __attribute__((swift_name("display_decimal")));
@property (readonly) BOOL is_active __attribute__((swift_name("is_active")));
@end;

__attribute__((swift_name("CoinConfigQueries")))
@protocol SharedCoinConfigQueries <SharedRuntimeTransacter>
@required
- (void)insertConfigCoin_symbol:(NSString *)coin_symbol coin_name:(NSString *)coin_name coin_decimal:(int32_t)coin_decimal display_decimal:(int32_t)display_decimal accent_color:(NSString *)accent_color is_active:(BOOL)is_active __attribute__((swift_name("insertConfig(coin_symbol:coin_name:coin_decimal:display_decimal:accent_color:is_active:)")));
- (SharedRuntimeQuery<SharedCoinConfig *> *)selectAll __attribute__((swift_name("selectAll()")));
- (SharedRuntimeQuery<id> *)selectAllMapper:(id (^)(NSString *, NSString *, SharedInt *, SharedInt *, NSString *, SharedBoolean *))mapper __attribute__((swift_name("selectAll(mapper:)")));
- (void)swithBySymbolCoin_symbol:(NSString *)coin_symbol __attribute__((swift_name("swithBySymbol(coin_symbol:)")));
@end;
